 ...
 */
return array(
	'title'      => __( 'Large header with dark background', 'mcms-lite' ),
	...
	'content'    => '<!-- wp:group {"align":"full","style":{"elements":{"link":{"color":{"text":"var:preset|color|background"}}},"spacing":{"padding":{"top":"0px","bottom":"var(--wp--custom--spacing--large, 8rem)"}}},"backgroundColor":"foreground","textColor":"background","layout":{"inherit":true}} -->
					...
					<h2 class="alignwide" style="font-size:clamp(3.25rem, 8vw, 6.25rem);line-height:1.15">' . wp_kses_post( __( '<em>mcms</em>: a WordPress template', 'mcms-lite' ) ) . '</h2>
					<!-- /wp:heading --></div>
					<!-- /wp:group -->
