...
return array(
	...
	'content'    => '<!-- wp:columns {"verticalAlignment":"center","align":"wide"} -->
					...
					<h2>' . wp_kses_post( __( 'Watch WP news fly<br> to your inbox', 'mcms-lite' ) ) . '</h2>
					<!-- /wp:heading -->

					<!-- wp:buttons -->
					<div class="wp-block-buttons"><!-- wp:button {"fontSize":"medium"} -->
					<div class="wp-block-button has-custom-font-size has-medium-font-size"><a class="wp-block-button__link">' . esc_html__( 'Join our mailing list', 'mcms-lite' ) . '</a></div>
					<!-- /wp:button --></div>
					<!-- /wp:buttons --></div>
					<!-- /wp:column -->
