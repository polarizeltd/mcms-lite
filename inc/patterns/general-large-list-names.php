 ...
 */
return array(
	'title'      => __( 'Large list of names', 'mcms' ),
	...
	'content'    => '<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"6rem","bottom":"6rem"}},"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"backgroundColor":"tertiary","textColor":"primary","layout":{"inherit":true}} -->
					...
					<figure class="wp-block-image size-full is-resized"><img src="' . esc_url( get_template_directory_uri() ) . '/assets/placeholder.jpg" alt="' . esc_attr__( 'A placeholder image', 'mcms' ) . '" width="175" height="82"/></figure>
					<!-- /wp:image --></div>
					<!-- /wp:group -->
					...
					<p class="has-x-large-font-size" style="font-weight:300">' . esc_html__( 'Aenean hendrerit tincidunt tellus, quis vehicula nibh pharetra ullamcorper. Ut bibendum pharetra metus. Etiam blandit sem vel quam convallis, ultricies suscipit turpis hendrerit. ', 'mcms' ) . '</p>
					<!-- /wp:paragraph -->
					...
					<div class="wp-block-button"><a class="wp-block-button__link has-background-color has-primary-background-color has-text-color has-background">' . esc_html__( 'Read more', 'mcms' ) . '</a></div>
					<!-- /wp:button --></div>
					<!-- /wp:buttons --></div>
					<!-- /wp:group --></div>
					<!-- /wp:group -->',
