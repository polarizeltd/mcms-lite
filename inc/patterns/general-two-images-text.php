 ...
 */
return array(
	'title'      => __( 'Two images with text', 'mcms' ),
	...
	'content'    => '<!-- wp:columns {"align":"wide"} -->
					...
					<h2 class="has-x-large-font-size" id="screening">' . esc_html__( 'SCANNING', 'mcms' ) . '</h2>
					<!-- /wp:heading -->
					...
					<div class="wp-block-button"><a class="wp-block-button__link has-foreground-background-color has-background">' . esc_html__( 'Buy Tickets', 'mcms' ) . '</a></div>
					<!-- /wp:button --></div>
					<!-- /wp:buttons --></div>
					<!-- /wp:column --></div>
					<!-- /wp:columns -->',
